        ...
        if (count($eqLogics) == 0) {
            ...
            <div class="eqLogicThumbnailContainer">
                ...
                foreach ($eqLogics as $eqLogic) {
                    ...
                    echo "<center>";
                    echo '<img src="plugins/jebble/doc/images/jebble_icon.png" height="105" width="95" />';
                    echo "</center>";
        ...
        <form class="form-horizontal">
            <fieldset>
				...
				<div class="form-group">
                    <label class="col-lg-3 control-label">{{Nom du profil}}</label>
                    <div class="col-lg-3">
                        <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                        <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom du profil}}"/>
                    </div>
                </div>
				<div class="form-group">
...
<?php include_file('desktop', 'jebble', 'js', 'jebble'); ?>
